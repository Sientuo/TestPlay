...
namespace TestPlay.Controllers
{
    public class HomeController : Controller
    {
        ...
        public JsonResult SendMess()
        {
            ...
            {
                "oYJlo50A8jIbnR3NREFl2qQgUoEg"
            };

            var data = SendTempletHelper.SendTempletMessge(list);
        ...
        */
        public string GetPrePayUrl(string productId)
        {
            ...
            data.SetValue("appid", "wx95792357cac264a6");//公众帐号id
            data.SetValue("mch_id", "1543013111");//商户号
       ...
       */
        ...
        {
            WxPayData data = new WxPayData();
            data.SetValue("body", "厦门劢联科技");//商品描述
            data.SetValue("attach", "测试测试测试");//附加数据
